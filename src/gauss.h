...
void gaussian_sampler_S2(unsigned char *seed, int64_t sample[MIFE_NMODULI][MIFE_N], uint32_t slen);

void gaussian_sampler_S3(unsigned char *seed, int64_t sample[MIFE_NMODULI][MIFE_N], uint32_t slen);
*/
